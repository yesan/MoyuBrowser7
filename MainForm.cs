...
namespace SharpBrowser
{
    ...
    internal partial class MainForm : Form
    {
        ...
        public static string Branding = "魔鱼斯拉鹏_隐身高速浏览器";
        ...
        public static string HomepageURL = "http://www.2345.com/?k36910750";
        ...
        private string MaxSpeedWarming = "【已经到最快车速了】";
        private string MixSpeedWarming = "【醒醒,停了】";
        ...
        private void InitHotkeys()
        {
            ...
            //speed test trackBar1
            KeyboardHandler.AddHotKey(this, trackBar1_Scroll_Up, Keys.Up, true);
            KeyboardHandler.AddHotKey(this, trackBar1_Scroll_Dwon, Keys.Down, true);
        ...
        private void trackBar1_Scroll_Up()
        {
            if (CurrentSpeedLevel < 5)
            {
                ...
                {
                    case 5: btn_5d_Click(null, null); break;
                    case 4: btn_4d_Click(null, null); break;
                    case 3: btn_3d_Click(null, null); break;
                    case 2: btn_2d_Click(null, null); break;
                    default:
                        btn_1d_Click(null, null);
                        break;
                }
            }
            else
            {
                if (!lb_speed.Text.Contains(MaxSpeedWarming))
                {
                    lb_speed.Text = lb_speed.Text + MaxSpeedWarming;
                }

            }
        }

        private void trackBar1_Scroll_Dwon()
        {
            if (CurrentSpeedLevel >= 1)
            {
                ...
                switch (CurrentSpeedLevel)
                {
                    ...
                    case 3: btn_3d_Click(null, null); break;
                    case 2: btn_2d_Click(null, null); break;
                    case 1: btn_1d_Click(null, null); break;
                    case 0: btn_pd_Click(null, null); break;
                    default:
                        btn_pd_Click(null, null);
                        break;
                }
            }
        }
        ...
        {
            var num = trackBar1.Value;
            lb_Toumingdu.Text = double.Parse(num.ToString()) / 10 + "";
            this.Opacity = double.Parse(num.ToString()) / 10;
        }
        ...
        private void btn_zdd_Click(object sender, EventArgs e)
        {
            var ran = new Random();
            double RandKey = double.Parse(ran.Next(1, 10).ToString());
            var k = double.Parse((RandKey / 10.00).ToString());
            OpacityChange(k);
        }
        ...
        private void btn_4d_Click(object sender, EventArgs e)
        {
            OpacityChange(0.3);
        }

        private void btn_5d_Click(object sender, EventArgs e)
        {
            OpacityChange(0.2);
        }

        private void OpacityChange(double num)
        {
            this.Opacity = num;
            trackBar1.Value = int.Parse((num * 10).ToString());
            lb_speed.Text = "档位:" + CurrentClassStr(num) + "  当前车速:" + (300 - (num * 200)) + "公里每小时";
        }

        private string CurrentClassStr(double num)
        {
            var danStr = "";
            if (num >= 0.8)
            {
